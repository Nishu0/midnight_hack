...
export type ImpureCircuits<PS> = {
  ...
  startNextBatch(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
}
...
export type PureCircuits = {
  tickKey(bid_0: bigint, tick_0: bigint): Uint8Array;
  orderCommitment(o_0: Order, sk_0: Uint8Array, bid_0: bigint): Uint8Array;
  revealNullifier(o_0: Order, sk_0: Uint8Array, bid_0: bigint): Uint8Array;
...
export type Circuits<PS> = {
  tickKey(context: __compactRuntime.CircuitContext<PS>,
          bid_0: bigint,
          tick_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
  ...
  claimNullifier(context: __compactRuntime.CircuitContext<PS>,
                 ...
                 sk_0: Uint8Array,
                 bid_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
  cancelNullifier(context: __compactRuntime.CircuitContext<PS>,
                  o_0: Order,
                  sk_0: Uint8Array,
                  bid_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
